...
### 📌 Volatility 
หมายถึง "ความผันผวน" หรือ "ระดับความไม่แน่นอน" ของราคาสินทรัพย์ วัดจากการกระจายตัวของผลตอบแทน (returns) ใช้เพื่อวัดระดับความผันผวนของสินทรัพย์ ถ้าค่าสูงแสดงว่าราคามีการแกว่งตัวแรง (เสี่ยงสูง) ถ้าค่าต่ำแปลว่าราคาเคลื่อนไหวคงที่กว่า (เสี่ยงต่ำ)
...
คือ ตัวชี้วัดความเสี่ยงที่ใช้วัดการลดลงสูงสุดของราคาสินทรัพย์จากจุดสูงสุด (Peak) ไปยังจุดต่ำสุด (Trough) ก่อนที่ราคาจะฟื้นตัว  

MDD บอกว่าในช่วงเวลาที่แย่ที่สุด นักลงทุนอาจขาดทุนเป็นเปอร์เซ็นต์เท่าไร
